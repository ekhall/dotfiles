...
ENCRYPTION_PIPE = ['gpg', '--encrypt', '--recipient', 'hall@absinthe.org']
...
registrations = {
    ...
    'microsoft': {
        'authorize_endpoint': 'https://login.microsoftonline.com/dd8cbebb-2139-4df8-b411-4e3e87abeb5c/oauth2/v2.0/authorize',
        'devicecode_endpoint': 'https://login.microsoftonline.com/dd8cbebb-2139-4df8-b411-4e3e87abeb5c/oauth2/v2.0/devicecode',
        'token_endpoint': 'https://login.microsoftonline.com/dd8cbebb-2139-4df8-b411-4e3e87abeb5c/oauth2/v2.0/token',
        'redirect_uri': 'https://login.microsoftonline.com/common/oauth2/nativeclient',
        'tenant': 'dd8cbebb-2139-4df8-b411-4e3e87abeb5c',
